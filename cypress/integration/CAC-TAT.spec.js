...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function(){
        cy.get('#firstName')
            .type('Wilson')
            .should('have.value','Wilson')
            .clear()
            .should('have.value','')
            cy.get('#lastName')
            .type('Barboza Silva Santos')
            .should('have.value','Barboza Silva Santos')
            .clear()
            .should('have.value','')
            cy.get('#email')
            .type('willssan04@gmail.com')
            .should('have.value','willssan04@gmail.com')
            .clear()
            .should('have.value','')
            cy.get('#phone')
            .type('123456')
